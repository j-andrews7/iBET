                ...
                fluidRow(
                    column(
                        ...
                        span(
                            ...
                            div(downloadButton("dl_plot.ov.bar", "Download Volcano Plot", class = "btn-dl"), style = "display:inline-block; float:right"),
                            withSpinner(jqui_resizable(plotlyOutput("ov.bar")))
                        )
                    ),
                    column(
                        width = 9,
                        fluidRow(
                            column(width = 8,
                                span(
                                    ...
                                    div(downloadButton("dl_plot.ov.swoosh", "Download Rank Plot", class = "btn-dl"), style = "display:inline-block; float:right"),
                                    withSpinner(jqui_resizable(plotlyOutput("ov.swoosh")))
                                )
                            ),
                            column(width = 4,
                                span(
                                    ...
                                    div(downloadButton("dl_plot.ov.le", "Download Rank Plot", class = "btn-dl"), style = "display:inline-block; float:right"),
                                    withSpinner(jqui_resizable(plotlyOutput("ov.le")))
                                )
                            )
                        )
                    ),
