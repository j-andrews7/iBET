...
### Using with DESeq2 (backward compatible)

The `shinyDESeq2` function works exactly as before for backward compatibility:
...
Alternatively, you can use the new generic `shinyDE` function directly with any DE results. See `?shinyDE` for details on using results from edgeR, limma, or other tools.
